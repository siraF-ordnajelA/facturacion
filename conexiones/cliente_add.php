<?php
   ...
   $query2 = "call agrega_cliente('$razon', '$nombre', $tipo_cliente, '$domicilio', '$localidad', '$cuit', $abono, $empleados, '$observaciones', '$cp', $provincia, '$nombre1', '$nombre2', '$nombre3', '$nombre4', '$nombre5', '$nombre6', '$nombre7', '$nombre8', '$nombre9', '$nombre10', '$c1', '$c2', '$c3', '$c4', '$c5', '$c6', '$c7', '$c8', '$c9', '$c10', '$email1', '$email2', '$email3', '$email4', '$email5', '$email6', '$email7', '$email8', '$email9', '$email10');";
   ...
   if ($cuenta > 0){
      ...
      if ($tipo_cliente == 1) {
         ...
         echo "Se agrego correctamente el proveedor.";
      }
   }
?>