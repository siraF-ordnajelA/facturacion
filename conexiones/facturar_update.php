<?php
   ...
   $query = "call edita_facturar($id_factura, $id_cliente, '$fecha', $puntov, $comprobante, $importe, $iva, $tipo_factura, $opc_cobro, '$observaciones');";
   $respuesta = mysqli_query($conexion, $query);

   mysqli_close($conexion);
   echo "Se modifico correctamente la factura recibida.";
?>